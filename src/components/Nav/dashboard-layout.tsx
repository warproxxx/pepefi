...
import { connectWalletAndGetData, disconnectAndClearData, getAndSetVaults, getAndSetAssets, getAndSetMyLoans, setLoadingDone } from 'src/utils/reduxSlicesConnector';
