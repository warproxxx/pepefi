...
contract PepeAuction {
    ...
    function createAuction(uint256 _loanId, uint256 _startingPrice, uint256 _discountRate, address _nft, uint256 _nftId, uint256 _duration) public returns (uint256){
